...
namespace ResearchManagementSystem.Migrations
{
    ...
    [Migration("20241217100120_modify setting.cs")]
    partial class modifysettingcs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RemcSys.Models.Settings", b =>
                {
                    ...
                    b.Property<string>("lathalaNatureOfInvolvement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tuklasFieldOfStudy")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tuklasNatureOfInvolvement")
                        .HasColumnType("nvarchar(max)");
