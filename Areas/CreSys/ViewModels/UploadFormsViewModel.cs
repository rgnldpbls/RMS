    ...
    using ResearchManagementSystem.Areas.CreSys.Validations;
    ...
    namespace ResearchManagementSystem.Areas.CreSys.ViewModels
    {
        public class UploadFormsViewModel
        {
            ...
            public IEnumerable<EthicsForms>? EthicsForms { get; set; }
            public IEnumerable<EthicsApplicationForms>? EthicsApplicationForms { get; set; } // List for multiple forms
            public IEnumerable<EthicsApplicationLogs>? EthicsApplicationLog { get; set; } // For new logs when uploading the forms
            ...
            public bool QuestionsAdapted { get; set; }
            ...
            [RequiredIfHumanSubjects(ErrorMessage = "Form Upload is Required if minor subjects are involved.")]
            [Display(Name = "Form 12 Assent Form: ")]
            public IFormFile FORM12 { get; set; }
            public IFormFile? editFORM12 { get; set; }

            [RequiredIfMinors(ErrorMessage = "Form Upload is Required no humans are involved.")]
            ...
            [Required(ErrorMessage = "Form Upload is Required.")]
            [Display(Name = "Certificate of Reliability: ")]
            public IFormFile CR { get; set; }
            public IFormFile? editCR { get; set; }   
        
            [Required(ErrorMessage = "Form Upload is Required.")]
            [Display(Name = "Questionnaire: ")]
            public IFormFile QST { get; set; }
            public IFormFile? editQST { get; set; }
