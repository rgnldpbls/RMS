...
public class rscSysfinalDbContext : DbContext
{
    ...
    public DbSet<Draft> RSC_Drafts { get; set; }
    public DbSet<Requirement> RSC_Requirements { get; set; }
    public DbSet<Request> RSC_Requests { get; set; }
    public DbSet<Memorandum> RSC_Memorandums { get; set; }
    public DbSet<StatusHistory> RSC_StatusHistories { get; set; }
    public DbSet<Notifications> RSC_Notifications { get; set; }
    public DbSet<DocumentHistory> RSC_DocumentHistories { get; set; }
    public DbSet<EvaluatorAssignment> RSC_EvaluatorAssignments { get; set; }
    public DbSet<ApplicationType> RSC_ApplicationTypes { get; set; }
    public DbSet<Checklist> RSC_Checklists { get; set; }
    public DbSet<ApplicationSubCategory> RSC_ApplicationSubCategories { get; set; }
    public DbSet<Evaluator> RSC_Evaluators { get; set; }

    public DbSet<EvaluationForm> RSC_EvaluationForms { get; set; }
    public DbSet<Criterion> RSC_Criteria { get; set; }
    public DbSet<EvaluationFormResponse> RSC_EvaluationFormResponses { get; set; }

    public DbSet<EvaluationGeneralComment> RSC_EvaluationGeneralComments { get; set; }
    public DbSet<EvaluationDocument> RSC_EvaluationDocuments { get; set; }
    public DbSet<GeneratedReport> RSC_GeneratedReports { get; set; }
    public DbSet<FinalDocument> RSC_FinalDocuments { get; set; }
    public DbSet<Template> RSC_Templates { get; set; }
